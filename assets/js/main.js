...
function scrollHeader(){
    const nav = docment.getElementById('header')
    // when the acroll is greater than 200 viewport height, add the scroll-header class to the header tag
...
/*==================== DARK LIGHT THEME ====================*/ 
 ...
 // we obtain the current theme that the interface fas by validating te dark-theme class
 const getcurrentTheme = () => document.body.classList.contains(darkTheme) ? 'dark' : 'light'
 const getcurrentIcon = () => themeButton.classList.contains(iconTheme) ? 'uil-moon' : 'uil-sun'

 // We validate if the user previouslly chose a topic
 if (selectedTheme) {
